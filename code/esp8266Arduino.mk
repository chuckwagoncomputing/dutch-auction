...
ALIBDIRS = $(sort $(dir $(wildcard \
	...
	$(ARDUINO_LIBS:%=$(ARDUINO_HOME)/libraries/%/*.h) \
...
CPREPROCESSOR_FLAGS = -D__ets__ -DICACHE_FLASH -U__STRICT_ANSI__ -I$(ESPRESSIF_SDK)/libc/xtensa-lx106-elf/include -I$(ESPRESSIF_SDK)/include -I$(ESPRESSIF_SDK)/lwip/include
...
ELFLIBS = -lm -lgcc -lhal -lphy -lpp -lnet80211 -lwpa -lcrypto -lmain -lwps -laxtls -lsmartconfig -lmesh -lwpa2 -llwip_gcc -lstdc++ -lespnow

ELFFLAGS = -g -w -Os -nostdlib -Wl,--no-check-sections -u call_user_start -u _printf_float -u _scanf_float -Wl,-static \
	 -L$(ESPRESSIF_SDK)libc/xtensa-lx106-elf/lib -L$(ESPRESSIF_SDK)/lib -L$(ESPRESSIF_SDK)/ld \
